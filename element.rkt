;; Specifies an element-class. The purpose of an element is to keep track of for example its values, candidates and if it's a user-entered value, and to be able to move
;; from one element to the next. It also knows which row, col and box it belongs to. "Friends" is the union of these.
